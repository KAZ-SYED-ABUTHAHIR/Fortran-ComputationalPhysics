...
Program HeatDirichlet
    ...
    Do i = 2,L-1,1
        Grid_Old(i,1) = 3.70d0 - (3.30d0/dFloat(L-1))*dFloat(i) ; Grid(i,1) = Grid_Old(i,1)
        Grid_Old(i,L) = 3.70d0 - (3.30d0/dFloat(L-1))*dFloat(i) ; Grid(i,L) = Grid_Old(i,L)
    End Do
